...
var api = new ParseServer({
  ...
  serverURL: process.env.SERVER_URL || 'http://192.168.1.4:1337/parse',  // Don't forget to change to https if needed
  liveQuery: {
...
  "apps": [
    {
      "serverURL": "http://192.168.1.4:1337/parse",
      "appId": "19453386",
      "masterKey": "1234",
      "appName": "MyApp"
    }
...
// MQTT Server Add
var mqttClient_test = require('./additional_components/mqtt/mqttClient');
mqttClient_test.OpenMqttClent();
