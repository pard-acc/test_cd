...
sendPutRequestToREST = function (className, objectId, data, callback) { 
    $.ajax({
        url : "http://" + host + "/parse/classes/" + className + "/" + objectId,
        type : "put",
        headers : headers,
        data : JSON.stringify(data),
        success : function (status) {
...
sendDeleteRequestToREST = function (className, objectId, callback) { 
    $.ajax({
        url : "http://"+host+"/parse/classes/" + className  + "/" + objectId,
        type : "delete",
        headers : headers,
